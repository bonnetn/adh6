...
export class TemporaryAccountService {
    ...
    public temporaryAccountDelete(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/temporary_account/`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public temporaryAccountPost(body: Body1, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse2001>;
    public temporaryAccountPost(body: Body1, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse2001>>;
    public temporaryAccountPost(body: Body1, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse2001>>;
    public temporaryAccountPost(body: Body1, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<InlineResponse2001>(`${this.basePath}/temporary_account/`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
